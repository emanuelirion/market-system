...
import com.emanuel.services.BranchAnalyticsService;
...
public class BranchAnalyticsServiceImpi implements BranchAnalyticsService {
    ...
    @Override
    public List<DailySalesDTO> getDailySalesCharts(Long branchId, int days) {
    ...
    public List<CashierPerformanceDTO> getTopCashierPerformanceByOrders(Long branchId) {
        ...
        return rawData.stream()
                ...
                .map(obj -> CashierPerformanceDTO.builder()
                        ...
                        .totalRevenue((Double) obj[2]).build()).collect(Collectors.toList());
    }
    ...
    public List<PaymentSummary> getPaymentMethodBreakdown(Long branchId, LocalDate date) {
        ...
        double total = rawData.stream().mapToDouble(obj -> (Double) obj[1]).sum();
    ...
    public BranchDashboardOverviewDTO getBranchOverview(Long branchId) {
        ...
        int todayOrders = orderRepository.countOrdersByBranchAndDate(
                branchId, today
        );
